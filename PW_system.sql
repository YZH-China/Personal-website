...
-- Table `sakila`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`user` ;
...
CREATE TABLE IF NOT EXISTS `sakila`.`user` (
  ...
  `reg_datetime` DATE NOT NULL COMMENT '注册日期时间',
  `user_email` VARCHAR(45) NOT NULL COMMENT '注册用邮箱',
  `head_portrait` VARCHAR(45) NULL COMMENT '头像图片保存的路由',
  PRIMARY KEY (`user_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sakila`.`article`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`article` ;

CREATE TABLE IF NOT EXISTS `sakila`.`article` (
  `article_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(45) NOT NULL COMMENT '文章题目',
  `content` MEDIUMTEXT NULL COMMENT '文章内容，存储着打断html文本',
  `create_date` DATE NOT NULL COMMENT '创建日期',
  `state` TINYINT(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '文章状态：\n    value: 1， 正常状态（可读、写）\n    value: 0， 待删除状态（只读）',
  `user_id` INT UNSIGNED NOT NULL COMMENT '用户id 表明该文章属于谁\n写 权限只存在于管理员',
  PRIMARY KEY (`article_id`),
  INDEX `fk_article_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_article_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `sakila`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `sakila`.`tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`tag` ;

CREATE TABLE IF NOT EXISTS `sakila`.`tag` (
  `tag_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `tag_name` VARCHAR(45) NOT NULL COMMENT '显示在页面上的文字',
  `tag_desc` VARCHAR(45) NOT NULL COMMENT '一段描述',
  `tag_type` TINYINT(1) NOT NULL COMMENT '表示此tag的类型\n    value: 1， 文章\n    value: 2， 图片\n    value: 3， 游戏',
  PRIMARY KEY (`tag_id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sakila`.`article_tag_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`article_tag_mapping` ;

CREATE TABLE IF NOT EXISTS `sakila`.`article_tag_mapping` (
  `idarticle_tag_mapping` INT NOT NULL,
  `article_id` INT UNSIGNED NOT NULL COMMENT '文章id',
  `tag_id` INT UNSIGNED NOT NULL COMMENT '标签id',
  PRIMARY KEY (`idarticle_tag_mapping`),
  INDEX `fk_article_tag_mapping_article1_idx` (`article_id` ASC),
  INDEX `fk_article_tag_mapping_tag1_idx` (`tag_id` ASC),
  CONSTRAINT `fk_article_tag_mapping_article1`
    FOREIGN KEY (`article_id`)
    REFERENCES `sakila`.`article` (`article_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_article_tag_mapping_tag1`
    FOREIGN KEY (`tag_id`)
    REFERENCES `sakila`.`tag` (`tag_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sakila`.`picture`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`picture` ;

CREATE TABLE IF NOT EXISTS `sakila`.`picture` (
  `pritre_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `url` VARCHAR(100) NOT NULL COMMENT '图片存储的路径',
  `desc` VARCHAR(45) NULL COMMENT '对图片的简短描述',
  `upload_date` DATE NOT NULL COMMENT '图片上传日期',
  `user_user_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`pritre_id`),
  INDEX `fk_picture_user1_idx` (`user_user_id` ASC),
...
-- -----------------------------------------------------
-- Table `sakila`.`picture_tag_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`picture_tag_mapping` ;

CREATE TABLE IF NOT EXISTS `sakila`.`picture_tag_mapping` (
  `idpicture_tag_mapping` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `picture_pritre_id` INT UNSIGNED NOT NULL,
  `tag_tag_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idpicture_tag_mapping`),
  INDEX `fk_picture_tag_mapping_picture1_idx` (`picture_pritre_id` ASC),
  INDEX `fk_picture_tag_mapping_tag1_idx` (`tag_tag_id` ASC),
  CONSTRAINT `fk_picture_tag_mapping_picture1`
    FOREIGN KEY (`picture_pritre_id`)
    REFERENCES `sakila`.`picture` (`pritre_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
